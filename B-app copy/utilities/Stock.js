    ...
    const renderButtons = () => {
        ...
        for (let i = 0; i < stockList.length; i++) {
            ...
            views.push(
                ...
                <View key={i} style={{ width: "100%", backgroundColor: "#030000", height: 70, marginTop: 10, paddingLeft: 30, justifyContent: "center", borderBottomColor: "#454545", borderBottomWidth: 0.5 }} >

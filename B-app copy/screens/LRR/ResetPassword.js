...
//             <Text style={{ color: "orange", fontSize: 28, fontWeight: "bold" }} >Reset Password</Text>
...
//                 </View>
//             </View>
//             <Button disabled={email.length < 4} containerStyle={[styles.button, { marginTop: 15 }]} buttonStyle={{ backgroundColor: "orange", width: 290, borderRadius: 11 }} title="Reset Password" onPress={() => resetPassword()} />

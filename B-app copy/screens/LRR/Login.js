...
const LoginScreen = ({ navigation }) => {
    ...
    return (
        <View behavior="padding" style={styles.container} >
            ...
            <Text style={{ color: "#cf3f02", fontSize: 28, fontWeight: "bold" }}>Login</Text>
            ...
            <View style={styles.inputField}>
                ...
                <View style={{ marginRight: 10 }} >
                    <TouchableOpacity>
                        <MaterialCommunityIcons name={data.secureTextEntry ? "eye-off" : "eye"} onPress={updateSecureTextEntry} color="#cf3f02" size={20} />
                    </TouchableOpacity>
                </View>
            </View>
            <Button onPress={signIn} disabled={email.length < 4 || password.length < 8} containerStyle={[styles.button, { marginTop: 20 }]} buttonStyle={{ backgroundColor: "#cf3f02", width: 290, borderRadius: 11 }} title="Sign in" />
            {error.length > 0 && <Text style={styles.errorMsg} >{error}</Text>}
            <Button onPress={() => navigation.navigate("Register")} containerStyle={[styles.button, { marginTop: 10 }]} buttonStyle={{ backgroundColor: "#cf3f02", width: 290, borderRadius: 11 }} title="Register" />

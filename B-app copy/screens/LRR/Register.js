...
const RegisterScreen = ({ navigation }) => {
    ...
    return (
        <View behavior="padding" style={styles.container}>
            ...
            <Text style={{ color: "#cf3f02", fontSize: 28, fontWeight: "bold" }}>Register</Text>
            ...
            <Button onPress={register} disabled={!userName || !email || password.length < 8 || confirmPassword.length < 8 || password != confirmPassword} containerStyle={[styles.button, { marginTop: 20 }]} buttonStyle={{ backgroundColor: "#cf3f02", width: 290, borderRadius: 11 }} title="Sign up" />
